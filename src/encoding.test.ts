...
import { createContext, variable, encodeBase, encodeConstraint, encodePuzzle } from './encoding';
...
function decodeSolution(ctx: ReturnType<typeof createContext>, assignment: Map<number, boolean>): Record<string, number> {
